...
* Manuscripts, result figures, experimental exports, internal implementation records, and real-robot deployment documentation.
...
5. Preserve all required upstream attributions in `LICENSE` and `THIRD_PARTY_NOTICES.md`.
